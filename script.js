...
AWS.config.region = 'us-east-1'; // REGION de DynamoDB
AWS.config.credentials = new AWS.Credentials('AKIAW3MECCLU3QM5PEND', '6TIfTdaJ+T0ogW5QJKtoQWFOx3VoAC0DlvgHaN+B'); //  Credenciales de AWS
            ...
            if (data.Items.length > 0) {
                ...
                if (userResponse !== null && userResponse.trim() !== '') {
                    ...
                    getNextId(function(nextId) {
                        ...
                        var putParams = {
                            TableName: 'Preguntas', // Nombre de Tabla en DynamoDB
                            Item: {
